...
class Survey extends Base {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( $this->slug . '-survey', plugins_url( 'assets/css/survey.css', PVC ), [], $this->plugin['Version'] );
		wp_enqueue_script( $this->slug . '-survey', plugins_url( 'assets/js/survey.js', PVC ), [ 'jquery' ], $this->plugin['Version'], true );
	}
    ...
    public function admin_notices() {
        ...
        <div id="<?php echo $this->slug; ?>-survey-notice" class="wpplugines-survey-notice notice notice-success is-dismissible wpplugines-survey wpplugines-notice wpplugines-shadow" data-slug="<?php echo $this->slug; ?>">
        	...
        	<img class="wpplugines-survey-img" src="<?php echo plugins_url( 'assets/img/survey.png', PVC ); ?>" />
